...
ncclResult_t initTransportsNewRank(struct ncclComm* comm, const struct ncclComm* peerComm) {
  ...
  for (int r = 0; r < nranks; r++) {
    ...
    allTopoRanks[r]->ringRecv[0] = 0;
    allTopoRanks[r]->ringSend[0] = nranks - 1;
    allTopoRanks[r]->ringPrev[0] = r - 1;
    allTopoRanks[r]->ringNext[0] = r + 1 < nranks ? r + 1 : -1;
    allTopoRanks[r]->treeToChild0[0] = 1;
    allTopoRanks[r]->treeToChild1[0] = 1;
  }
